...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf starter-node-temp && mkdir starter-node-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'cp -r starter-node-temp/* starter-node/ && rm -rf starter-node-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd starter-node && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
